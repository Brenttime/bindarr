...
Scrybox is a **self-hosted** application. You run your own Scrybox server and
your own database. The developer of Scrybox does **not** operate a hosted
...
advertising, or tracking service. Scrybox contains no analytics SDKs, no ad
...
To identify cards and fetch prices and card images, your Scrybox **server**
...
Scrybox is not directed at children and collects no personal data on behalf of
the developer.

## Security

Passwords are stored hashed. Because you host Scrybox yourself, securing your
...
Questions or issues: <https://github.com/Brenttime/scrybox/issues>
